...
ggsave("pics/3_2_histograma_circ_tronco_bins_10_separado_por_inclinacion.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics/3_2_histograma_circ_tronco_bins_20_separado_por_inclinacion.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics/3_2_histograma_circ_tronco_bins_30_separado_por_inclinacion.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics/3_2_histograma_circ_tronco_bins_40_separado_por_inclinacion.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics/3_2_histograma_circ_tronco_bins_50_separado_por_inclinacion.png", plot = last_plot(), width = 8, height = 6)
```
