...
# undersampling
set.seed(2023)
indeces_inclinacion_peligrosa_0 <- caret::createDataPartition(data_inclinacion_peligrosa_0$inclinacion_peligrosa, p = 0.1, list = FALSE)
...
ggsave("pics_balanced/2_1_distribucion_inclinacion_peligrosa.png", plot = last_plot(), width = 6, height = 4)
```
...
ggsave("pics_balanced/2_2_peligrosidad_secciones.png", plot = last_plot(), width = 8, height = 6)
...
ggsave("pics_balanced/2_2_peligrosidad_nombre_secciones.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/2_3_peligrosidad_especies.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_1_histograma_circ_tronco_bins_10.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_1_histograma_circ_tronco_bins_20.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_1_histograma_circ_tronco_bins_30.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_1_histograma_circ_tronco_bins_40.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_1_histograma_circ_tronco_bins_50.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_2_histograma_circ_tronco_separado_por_inclinacion_bins_10.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_2_histograma_circ_tronco_separado_por_inclinacion_bins_20.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_2_histograma_circ_tronco_separado_por_inclinacion_bins_30.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_2_histograma_circ_tronco_separado_por_inclinacion_bins_40.png", plot = last_plot(), width = 8, height = 6)
```
...
ggsave("pics_balanced/3_2_histograma_circ_tronco_separado_por_inclinacion_bins_50.png", plot = last_plot(), width = 8, height = 6)
```
...
```{r}
write.csv(train_data, "data/arbolado-balanced-mendoza-dataset-circ_tronco_cm-train.csv", row.names = FALSE)
```
