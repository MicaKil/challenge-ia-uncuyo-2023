...
training_number <- round(row_number * training_proportion)
validation_number <- row_number - training_number

# genera un conjunto de índices aleatorios sin reemplazo (por default replace=FALSE) para las filas de validación
validation_indexes <- sample(1:row_number, validation_number)

# divide los datos en conjuntos de entrenamiento y validación
training_data <- data[-indices_validacion, ]  # el operador "-" indica que se excluyen los índices de validación
validation_data <- data[indices_validacion, ]
...
confusion_matrix <- create_confusion_matrix(random_prediction)
...
```{r}
# Cargar el archivo arbolado-mendoza-dataset-validation.csv como una data.frame y aplicarle la función
